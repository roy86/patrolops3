...
while { mpsf_IED_counter > } do {
	_posarray = _posarray call mpsf_fnc_arrayShuffle;

	_pos = [_ieds,_posarray] call mpsf_fnc_getIEDNewPos;	
...
["MARKIED",9] call mpsf_fnc_createIED;*/
...
// =========================================================================================================
	...
	[ format["TASK%1",PO3_TASK__IDD],
		...
		(po3_side_1 select 0),
		[format["MRKR%1",PO3_TASK__IDD],PO3_TASK__POS,"mil_objective","ColorOPFOR",format[localize "STR_PO3_M06_TITLE",_locaname]],
		"assigned",
		(PO3_TASK__POS),
		format[localize "STR_PO3_M06_TITLE",_locaname]
	] call mpsf_fnc_addTask;

	["PO3",format["Task: %1 %2 Generated at %3","SecureTown",PO3_TASK__IDD,_location],true] spawn mpsf_fnc_log;

...
// =========================================================================================================
	...
	PO3_TASK__POS	= [ [(_location select 0),0,random 360,false],50,4,5,0.5] call mpsf_fnc_getflatarea;
...
// =========================================================================================================
	...
	[ _container1, _container2] call mpsf_fnc_setAsLoadable;
...
//	_b = 2*(PO3_TASK__DIF*3);
	...
	for "_i" from 1 to _b do {
		...
		if !(isNil "_grp") then {
			[ _position, _grp, (100 * _i) ] spawn mpsf_fnc_groupPatrolArea;
...
// =========================================================================================================
	...
	[ format["TASK%1",PO3_TASK__IDD],
		...
		(po3_side_1 select 0),
		[format["MRKR%1",PO3_TASK__IDD],PO3_TASK__POS,"mil_objective","ColorBLUFOR",localize "STR_PO3_M11_TITLE"],
		"assigned",
		(PO3_TASK__POS),
		localize "STR_PO3_M11_TITLE"
...
// =========================================================================================================
	...
	waitUntil{ sleep 1;
		{_x distance _position < 30 && isNull(_x getVariable ["mpsf_loaded",objNull]) } count [_container1,_container2] > 0 || !(alive _container1 || alive _container2)
	};

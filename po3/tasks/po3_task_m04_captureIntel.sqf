...
// =========================================================================================================
	...
	_targetclass = po3_target_intel_types call mpsf_fnc_getArrayRandom;
...
// ========
	...
	for "_i" from 1 To (_numIntel + 4) do {
		_targetUnit = _inteUnitList call mpsf_fnc_getArrayRandom;
		_targetclass = po3_target_intel_types call mpsf_fnc_getArrayRandom;
		...
		intel setVariable ["mpsf_intel_capture",true,true];
...
/*
	{
		waitUntil{ sleep 1; _x distance ("return_point" call mpsf_fnc_getPos) < 10 };
...
*/
	...
	sleep 1;
	[format["TASK%1",_taskid],"succeeded"] call mpsf_fnc_updateTask;

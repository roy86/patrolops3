...
_action = _towVeh addAction [ format["<t color='#ffc600'>Detach %1</t>",[_object] call mpsf_fnc_getCfgText],{ [(vehicle player)] spawn mpsf_fnc_towObjectRelease; },[],100,false,true,"","!isNull (_target getVariable [""mpsf_isTowingObj"",objNull]) && speed _target < 1"];
...
//	titletext [format["%1 (%2) attached", [_object] call mpsf_fnc_getCfgText, typeof(_object)], "PLAIN DOWN"];
};

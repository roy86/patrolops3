/*
	...
	Syntax:
	[<aircraft>,<object>] call mpsf_fnc_createChute
...
if!(local _vehicle) then {
	_local = [_vehicle, player] call mpsf_fnc_requestOwnership;
...
[side (driver _vehicle),"SIDE",format [localize "STR_MPSF_LOGIST_SUPPLYDROP0",name (driver _vehicle),[_payload] call mpsf_fnc_getCfgText,mapGridPosition _position] ] call mpsf_fnc_sendChat;

/*
	...
	Syntax:
	_colour = (unit/group) call mpsf_fnc_getGroupSizeMarkerType;

	Example:
	_colour = (player) call mpsf_fnc_getGroupSizeMarkerType;
	_colour = (group player) call mpsf_fnc_getGroupSizeMarkerType;
*/

scriptName "mpsf\fnc\arrays\fn_consolidateArray.sqf";
/*
	Author: Jiri Wainar
	...
	Syntax:
	_cosolidated:array = _strings:array call mpsf_fnc_consolidateArray;
...
if (typeName _input != typeName []) exitWith {
	["fnc_Group_consolidateArray","Input must be an array of strings"] call mpsf_fnc_log;
	[]
};

scriptName "mpsf\fnc\config\fn_getCfgText.sqf";
/*
	Author: Eightysix
...
if(isNil "_class") exitWith { ["fnc_getCfgIcon",format["Detect Config TEXT Error of %1",_object]] call mpsf_fnc_log; "" };
if(typeName _class != "STRING") exitWith { ["fnc_getCfgIcon",format["Detect Config TEXT Error of %1",_object]] call mpsf_fnc_log; "" };

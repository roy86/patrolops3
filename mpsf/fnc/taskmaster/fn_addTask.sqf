/*
	...
	Example:
		["Task1","Task1Title","Task1Desc"] call mpsf_fnc_addTask
		["Task2","Task2Title","Task2Desc",true,["markerTask2",getpos obj2]] call mpsf_fnc_addTask
*/
if (!mpsfSRV) exitWith{};
...
mpsf_tasks_Tasks set [count mpsf_tasks_Tasks, [_name,_short,_long,_cond,_marker,_state,_dest,_chev]];
publicvariable "mpsf_tasks_Tasks";

if (mpsfCLI && mpsf_tasks_initDone) then {

...
player createDiaryRecord ["mpsfCR",["Version",format["MultiPlayer Scripting Framework<br/>Version %1",localize "STR_MPSF_VERSION"]]];

player createDiaryRecord ["mpsfWK",["Tasks","
...
//player createDiaryRecord ["mpsfWK",["Support","Support Requests are Work in Progress"]];

player createDiaryRecord ["mpsfWK",["Squad Markers",format["Squad Marker System<br/><br/>Any Squad friendly to your side is marked on the map via their respective icon.<br/><br/>The icon shows you what vehicle their team leader has occupied.<br/><img image='%1' width='25px'/> - Infantry<br/><img image='%2' width='25px'/> - Armour<br/><img image='%3' width='25px'/> - Helicopter<br/><img image='%4' width='25px'/> - Mechanised: <br/><img image='%5' width='25px'/> - Motorised<br/><img image='%6' width='25px'/> - Plane<br/><img image='%7' width='25px'/> - Static Weapon<br/><img image='%8' width='25px'/> - UAV<br/>",["n_inf"] call mpsf_fnc_getCfgIcon,["n_armor"] call mpsf_fnc_getCfgIcon,["n_air"] call mpsf_fnc_getCfgIcon,["n_mech_inf"] call mpsf_fnc_getCfgIcon,["n_motor_inf"] call mpsf_fnc_getCfgIcon,["n_plane"] call mpsf_fnc_getCfgIcon,["n_art"] call mpsf_fnc_getCfgIcon,["n_uav"] call mpsf_fnc_getCfgIcon] ] ];

player createDiaryRecord ["mpsfWK",["Spectator","
Spectator System<br/>
<br/>
...
player createDiaryRecord ["mpsfWK",["Redeployment","
...
/*
player createDiaryRecord ["mpsfWK",["NCWS","
Info about the Network Centric Warefare System
"]];
player createDiaryRecord ["mpsfWK",["Medical","
Medical System<br/>
<br/>
...
"]];
*/
player createDiaryRecord ["mpsfWK",["Logistics","
...
player createDiaryRecord ["mpsfWK",["IEDs","
IED System<br/>
<br/>
...
player createDiaryRecord ["mpsfWK",["HUD","The Player Hud<br/><br/>The hud allows you to set your view distance options, terrain detail and density and toggle the 3D names that appear above each of nearby players.<br/>These options can be disabled by the mission admin."]];
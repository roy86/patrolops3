scriptName "mpsf\fnc\ai\fn_setGroupDefend.sqf";
/*
	...
	Example:
		["Marker1",_GROUP,100] spawn mpsf_fnc_setGroupDefend;
...
if(isNil "_grp") exitWith { ["fnc_Group_Defend","Undefined Group"] call mpsf_fnc_log };
...
_nearByBuildings = [_position,_radius] call mpsf_fnc_getNearbyBuildings;

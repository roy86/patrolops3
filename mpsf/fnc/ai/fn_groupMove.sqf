scriptName "mpsf\fnc\ai\fn_group_moveAlongPath.sqf";
/*
	...
	Example:
		[<group>,[<position>,<position>,...] ] spawn mpsf_fnc_group_moveAlongPath
...
if(isNil "_positions") exitWith { ["fnc_Group_moveAlongPath","Undefined Positions"] call mpsf_fnc_log };
if(isNil "_grp") exitWith { ["fnc_Group_moveAlongPath","Undefined Group"] call mpsf_fnc_log };
...
for "_i" from 1 to _wpcount do {
	...
	_position = (_positions select (_i - 1)) call mpsf_fnc_getPos;

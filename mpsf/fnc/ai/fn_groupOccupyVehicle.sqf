scriptName "mpsf\fnc\ai\fn_group_occupyVehicle.sqf";
/*
	...
	Example:
		[TANKNAME,_groupID] spawn mpsf_fnc_group_occupyVehicle;
...
if(isNil "_grp") exitWith { ["fnc_Group_occupyVehicle","Undefined Group"] call mpsf_fnc_log };

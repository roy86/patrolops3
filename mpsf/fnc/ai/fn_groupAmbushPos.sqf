scriptName "mpsf\fnc\ai\fn_group_ambush.sqf";
/*
	...
	Syntax:
	[<position>,<group>] spawn mpsf_fnc_group_ambush
...
if(isNil "_grp") exitWith { ["fnc_Group_ambush","Undefined Group"] call mpsf_fnc_log };
